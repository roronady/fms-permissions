...
import { Plus, Edit, Trash2, Building, RefreshCw, DollarSign, User } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-600">Manage organizational departments and their details</p>
        </div>
              ...
              {departments.map((department) => (
                <tr key={department.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    {department.requisition_count || 0}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <button
                        ...
                        disabled={department.requisition_count > 0}
                        ...
                        title={department.requisition_count > 0 ? 'Cannot delete department with existing requisitions' : 'Delete department'}
                      >
